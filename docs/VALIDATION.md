...
用户确认后，已将 Codex Connector 安装到 Morus505 账号，范围仅为其 hoshino-maimai-updata fork，包含代码/PR/工作流读写。该授权不扩展到 AFKsuper 原仓库。安装前的403记录仅为历史排障证据；实际发布提交以远程分支记录为准。发布前重跑173项测试通过。
